/* $Id: upload_log.cpp 38986 2009-10-02 19:25:59Z mordante $ */
/*
...
{
	std::string msg = std::string(_("Open Sanguo relies on volunteers like yourself for feedback.Please visit Open Sanguo Project at,  http://code.google.com/p/opensanguo/ and join Open Sanguo discussion group to provide your feedback:  http://groups.google.com/group/opensanguo-discussion\n")) + "\n \n";
